package sen.vol.deposit.service;
...
import sen.vol.deposit.exception.DepositServiceException;
import sen.vol.deposit.repository.DepositRepository;
import sen.vol.deposit.rest.*;
...
public class DepositService {
    ...
    private BillRequestDTO createBillRequest(BigDecimal amount, BillResponseDTO billResponseDTO) {
        ...
        billRequestDTO.setCreationTime(billResponseDTO.getCreationTime());
